...
// quiero que me digan si la última letra de un texto (string) cualquiera es la letra a
// retornar un booleano

const text = 'Hola, me llamo Erik';
const text2 = 'Hola, me 1lamo Daniela';

const lastLetter1 = text[text.length -1] == 'a'
const lastLetter2 = text2[text2.length -1] == 'a'

console.log(lastLetter1, lastLetter2);



const email = "correo@academlo.com"

const includes = email.includes("@academlo.com")
